...
case class SensorDataMessage (time: LocalDateTime, data: SensorData, unit:String)
...
object SensorDataMessage{
  ...
  implicit def toLocalDateTime(dateTimeString: String): LocalDateTime = LocalDateTime.parse(dateTimeString, formatterDateTime)
